...
procedure HacerJugada(var mJugada: trJugada; var mMatriz: tMatriz; var mDirecciones: tDirecciones);
var
  i: byte;
...
begin
    ...
    begin
      ...
      if mJugada.direccionesValidas[i]> 0 then
         voltearFichas(mJugada, mMatriz, vDirecciones, i);
      else
          sigoRecorriendo:= false;
    end;
end;

procedure voltearFichas(var mJugada: trJugada; var mMatriz: tMatriz; var mDirecciones: tDirecciones; mDireccion:byte);
var
  jugadaAux: trJugada;
  sigoRecorriendo: boolean;
begin
    jugadaAux.x:= jugadaAux.x + mDirecciones[mJugada.direccionesValidas[mDireccion]].dirX;
    jugadaAux.y:= jugadaAux.y + mDirecciones[mJugada.direccionesValidas[mDireccion]].dirY;
